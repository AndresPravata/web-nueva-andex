  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-lg md:text-2xl font-semibold mb-8">
            Ganadores del BP INNOVA 2023
          </p>
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-normal mb-4">
            Fuimos finalistas en los programas que realizamos en 2024.
          </p>
          <div className="mb-8">
