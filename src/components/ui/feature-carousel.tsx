...
const steps = [
  {
    ...
    title: "Sistema de ventas",
    description:
      "Gestiona tu negocio de manera eficiente con nuestro sistema de ventas inteligente.",
  },
  {
    id: "2",
    name: "Totem Turnero",
  ...
  {
    id: "4",
    name: "Verdulería Autogestionable",
    title: "Verdulería Autogestionable",
    description:
      "Permite a los clientes gestionar su propia compra y pago. Ideal para verdulerías y tiendas de alimentación.",
  },
      ...
      >
        <div className="m-10 min-h-[450px] w-full">
          <AnimatePresence mode="wait">
            ...
            >
              <motion.h2
                className="text-xl font-bold tracking-tight text-white md:text-2xl mt-6"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{
                  delay: 0.1,
